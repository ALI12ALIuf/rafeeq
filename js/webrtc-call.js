...
const SWManager = {
    ...
    async register() {
        try {
            ...
            // ✅ استخدام SW المسجل من index.html
            // نبحث عن أي SW مسجل ونستخدمه
            const registrations = await navigator.serviceWorker.getRegistrations();
            if (registrations.length > 0) {
                this.swRegistration = registrations[0];
                this.swReady = true;
                console.log('✅ تم العثور على Service Worker مسجل');
                return true;
            }
            
            // إذا لم يوجد SW مسجل، نحاول التسجيل باستخدام Blob URL
            const swCode = `
...
`;
            ...
            console.log('✅ Service Worker تم تسجيله (من webrtc-call.js)');
...
// ✅ تسجيل SW عند بدء التشغيل (كخطة احتياطية)
