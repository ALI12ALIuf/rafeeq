    ...
    // ==================== معالجة الصورة ====================
        ...
        if (templateImg) {
            ...
            if (wrapper) {
                ...
                // ✅ زر الحفظ - الضغط المطول عليه يفتح قائمة Chrome
                const saveBtn = document.createElement('a');
                saveBtn.className = 'media-save-btn';
                saveBtn.href = msg.data;
                saveBtn.innerHTML = '<i class="fas fa-download"></i>';
                saveBtn.title = 'اضغط مطولاً للحفظ';
                // منع onclick العادي - فقط الضغط المطول يعمل
                saveBtn.onclick = (e) => e.preventDefault();
                // السماح بالضغط المطول (contextmenu) على الزر فقط
