        ...
        if (templateImg) {
            ...
            if (wrapper) {
                ...
                if (img) {
                    ...
                    // ✅ منع الضغط المطول على الصورة نفسها
                    img.oncontextmenu = (e) => e.preventDefault();
                    img.ondragstart = (e) => e.preventDefault();
                }
                // الزر في المودال - لا شيء هنا
            }
            div.appendChild(clone);
        } else {
    ...
    // ==================== معالجة الفيديو ====================
        ...
        if (templateVideo) {
            ...
            if (thumbnail) {
                ...
                // ✅ منع الضغط المطول على الفيديو نفسه
    ...
    // ==================== معالجة الملف ====================
        ...
        if (templateFile) {
            ...
            if (fileCard) {
                ...
                // ✅ زر تحميل الملف - يفتح ضغط مطول على الرابط
...
showImagePreview(imageSrc) {
    ...
    // ✅ ربط زر الحفظ بالصورة الحالية
    const saveBtn = document.getElementById('imgPreviewSaveBtn');
    if (saveBtn) saveBtn.href = imageSrc;
...
showVideoPreview(videoSrc) {
    ...
    modal.style.display = 'flex';
    video.play().catch(() => {});
    // ✅ ربط زر الحفظ بالفيديو الحالي
    const saveBtn = document.getElementById('vidPreviewSaveBtn');
    if (saveBtn) saveBtn.href = videoSrc;
},
