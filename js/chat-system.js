    ...
    if (msg.type === 'text') {
        ...
        if (templateImg) {
            ...
            if (wrapper) {
                ...
                wrapper.appendChild(MediaDownloader.createButton(msg.id, _name, 'image/jpeg', msg.data));
            }
            div.appendChild(clone);
        } else {
        ...
        if (templateVideo) {
            ...
            if (thumbnail) {
                ...
                thumbnail.appendChild(MediaDownloader.createButton(msg.id, _name, 'video/mp4', msg.data));
            }
            div.appendChild(clone);
        } else {
        ...
        if (templateFile) {
            ...
            if (fileCard) {
                ...
                const dlBtn = MediaDownloader.createButton(msg.id, _name, _mime, msg.data);
                dlBtn.style.position = 'static';
                dlBtn.style.margin = '6px 0 0 auto';
