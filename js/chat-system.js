...
displayMessage(msg) {
    ...
    // ==================== معالجة الفيديو ====================
        ...
        // تصميم فيديو مخصص - كل شيء داخل الإطار
        ...
        vidWrapper.onclick = (e) => { e.stopPropagation(); this.showVideoPreview(msg.data, borderColor); };
    ...
    // ==================== معالجة الملف ====================
        ...
        if (templateFile) {
            ...
            if (fileCard) {
                ...
                // زر الحفظ بالضغط المطول
                const saveBtn = document.createElement('a');
                saveBtn.className = 'media-save-btn file-save-btn';
...
showImagePreview(imageSrc, borderColor = '#4CAF50') {
    ...
    // تطبيق لون المرسل/المستلم على الإطار والأزرار
