...
// ========== متغير لحفظ آخر صفحة قبل فتح المحادثة ==========
...
// ========== فتح محادثة مع حفظ الصفحة السابقة ==========
window.openChat = friendId => {
    // حفظ الصفحة الحالية قبل فتح المحادثة
    if (document.body.classList.contains('profile-subpage-open')) {
        window._wasInSubPage = true;
        // معرفة أي صفحة فرعية مفتوحة
        if (document.getElementById('friendsPage') && document.getElementById('friendsPage').style.display !== 'none') {
            window._lastSubPageId = 'friendsPage';
        } else if (document.getElementById('friendRequestsPage') && document.getElementById('friendRequestsPage').style.display !== 'none') {
            window._lastSubPageId = 'friendRequestsPage';
        } else if (document.getElementById('tripsPage') && document.getElementById('tripsPage').style.display !== 'none') {
            window._lastSubPageId = 'tripsPage';
        }
        window._lastPageBeforeChat = 'profile-subpage';
    } else if (document.querySelector('.profile-page') && window.getComputedStyle(document.querySelector('.profile-page')).display !== 'none') {
        window._wasInSubPage = false;
...
// ========== إغلاق المحادثة والرجوع للصفحة السابقة ==========
window.closeConversation = () => { 
    CallSystem.endCall(); 
    ChatSystem.closeChat();
    
    setTimeout(() => {
        if (window._lastPageBeforeChat === 'profile-subpage' && window._wasInSubPage) {
            // الرجوع لنفس الصفحة الفرعية اللي كان فيها
            ...
            if (window._lastSubPageId === 'friendsPage') {
                document.getElementById('friendsPage') && (document.getElementById('friendsPage').style.display = 'block');
            } else if (window._lastSubPageId === 'friendRequestsPage') {
                document.getElementById('friendRequestsPage') && (document.getElementById('friendRequestsPage').style.display = 'block');
            } else if (window._lastSubPageId === 'tripsPage') {
